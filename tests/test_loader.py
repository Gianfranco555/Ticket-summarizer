...
def test_load_tickets_with_dates(tmp_path):
    csv_content = (
        "number,description,opened_at,resolved_at,closed_at,work_notes\n"
        "T-1,With date,2023-01-01T12:00:00Z,2023-01-02T15:30:00,not a date,some notes\n"
    ...
    assert ticket1.comments == "" # not in csv, should be default ""
